...
?>
		...
		<div class="login_box">
			...
			<?php echo form_open($this->uri->uri_string() , "id='login_form'"); ?>
				<div class="top_b" style="margin-left: 52;">Get a new Password</div>    
				<div class="cnt_b">
				...
				class="btm_b clearfix">
					...
					<?php echo form_submit('submit', 'Send',"class='btn btn-default btn-sm pull-right'"); ?>
		...
		<script src="<?php echo site_url('../bootstrap/js/bootstrap.min.js'); ?>"></script>        <script>
