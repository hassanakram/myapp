...
<html lang="en" class="login_page">
    <head>
        ...
        <title>My App - Calender Setting</title>
    ...
    <body>
		...
		<?php	echo form_open("auth/get_setting"); ?>
				<div class="top_b"  style="margin-left: 52;">Time Setting</div>    
				<div class="cnt_b">
					...
					<div class="form-group" style="margin-left: 25px">
						<div class="input-group">
								...
								<input type="submit" name="get_setting" value="Get Setting" class="btn btn-gebo" />

								<input type="hidden" name="set" value="set">

								<input type="submit" name="set_setting" value="Set Setting" class="btn btn-gebo" />
