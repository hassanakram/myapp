...
<html lang="en" class="login_page">
    ...
    <body>
		...
		<div class="login_box">
				...
				<div class="top_b"  style="margin-left: 52;">dispute this transaction</div>    
				<div class="cnt_b" style="padding-top: 0px; padding-bottom: 0px;">
					<div class="form-group">
						<div class="input-group">
							

						<?php 	echo form_open("bookings/dispute"); ?>
							 ...
							 <textarea style="width:250px" name="dispute" id="txtarea_sp" cols="20" rows="3" placeholder="Description of the dispute" class="form-control"></textarea>
