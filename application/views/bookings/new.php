...
?>
	...
	<?php echo form_open('bookings/book',"id='login_form'"); ?>
				<div class="top_b">Hire <strong> <?php echo $tutor_name; ?> </strong> as Tutor </div>
				
				<div class="cnt_b">

					<input type="hidden" name="user_id" value=<?php echo  $std_id; ?> >
				...
				<div class="btm_b tac">
					...
					<?php echo form_submit('Book', 'Book',"class='btn btn-default'"); ?>
